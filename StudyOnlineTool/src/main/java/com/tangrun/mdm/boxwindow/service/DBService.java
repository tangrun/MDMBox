...
public class DBService implements LifecycleEventListener {
    ...
    private void initConnectPool() {
        String db = System.getProperty("user.home") + File.separator + "AppData" + File.separator + "Roaming"
                + File.separator + BuildConfig.appUserDataDirName + File.separator + "data";

        connectionPool = JdbcConnectionPool.create("jdbc:h2:file:"+db+";FILE_LOCK=NO", "cdblue", "Cdblue123123!!");
    }
